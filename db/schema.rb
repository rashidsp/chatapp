...
ActiveRecord::Schema.define(version: 20160309110116) do
  ...
  add_index "conversations", ["title", "started_id"], name: "index_conversations_on_title_and_started_id", using: :btree
  ...
  add_index "user_conversations", ["user_id", "conversation_id"], name: "index_user_conversations_on_user_id_and_conversation_id", using: :btree
